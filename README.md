...
2. In the `wp-content/plugins` folder, clone the repository: `git clone git@github.com:lubusIN/slider-block.git`
3. Navigate to folder `cd wp-content/plugins/slider-block`.
