...
const AboutUs = {
	...
	content: `
           <!-- wp:group {"metadata":{"name":"About Us"},"align":"full","style":{"spacing":{"blockGap":"0px","padding":{"left":"2vw","right":"2vw","top":"8vw","bottom":"8vw"}}},"backgroundColor":"contrast","layout":{"type":"constrained","contentSize":"1000px"}} -->
            ...
            <!-- /wp:button --></div>
            <!-- /wp:buttons --></div><figure class="wp-block-media-text__media"><img src="https://slidertemplates.instawp.xyz/wp-content/uploads/2025/05/wordpress-log.png" alt="" class="wp-image-29 size-full"/></figure></div>
            <!-- /wp:media-text --></div>
            <!-- /wp:blablablocks/slide -->

            <!-- wp:blablablocks/slide {"className":"wp-block-lubus-slide"} -->
            <div class="wp-block-blablablocks-slide swiper-slide wp-block-lubus-slide"><!-- wp:media-text {"mediaPosition":"right","mediaId":10,"mediaLink":"https://slidertemplates.instawp.xyz/?attachment_id=10","mediaType":"image","mediaWidth":30,"style":{"spacing":{"blockGap":"15px"}}} -->
            <div class="wp-block-media-text has-media-on-the-right is-stacked-on-mobile" style="grid-template-columns:auto 30%"><div class="wp-block-media-text__content"><!-- wp:paragraph -->
            <p>Say Hello To</p>
            <!-- /wp:paragraph -->
            ...
            <!-- /wp:button --></div>
            <!-- /wp:buttons --></div><figure class="wp-block-media-text__media"><img src="https://slidertemplates.instawp.xyz/wp-content/uploads/2025/05/gutenberg-.png" alt="" class="wp-image-10 size-full"/></figure></div>
            <!-- /wp:media-text --></div>
            <!-- /wp:blablablocks/slide -->
