...
const HeroSection = {
	...
	content: `
            <!-- wp:blablablocks/slider {"navigation":{"desktop":false,"tablet":false,"mobile":false,"activeDevice":"desktop"},"loop":true,"paginationOffset":{"top":"0px","right":"0px","bottom":"30px","left":"0px"},"paginationPosition":"bottom center","paginationColor":{"activeColor":{"default":"#ffffff"}},"metadata":{"name":"Hero Section"},"align":"full","className":"wp-block-blablablocks-slider alignfull wp-block-lubus-slider","style":{"spacing":{"padding":{"top":"0px","bottom":"0px","left":"0px","right":"0px"}}}} -->
